    ...
    <Layout pageTitle="무료체험 어떠셨나요?">
      ...
      <div className="divmargin">
        ...
        <p>
          ...
          유료서비스는 클라이언트에게 할당된 권역의 <b>모든 검색수요</b>를 장악합니다.
          <ul>
            <li>
            ...
            <li>
              그 외에도 수천개 키워드를 조합해 해당 지역내 키워드 검색을 통한 롱테일
              수요를 모두 담아내게 됩니다.
            </li>
            <li>
      ...
      <div className="divmargin">
        ...
        <p>
          <ul>
            <li>폭탄블로그 일반형의 월간 약속물량은 <b>120건</b>입니다.</li>{" "}
            <li>
              이 정도도 타 업체대비 적지 않은 숫자이지만 저희 입장에서는
              불확실한 마케팅 환경에서의 돌발상황에 대처하기 위해 <b>보수적으로
              책정된 수치</b>입니다.
            </li>
            <li>
              실제 유료고객들의 월간 집행 물량은 이 숫자를 훨씬 상회합니다.
            </li>
            <li>
      ...
      <div className="divmargin">
        ...
        <p>
          마케팅 집행 현황을 <b>인트라넷을 통해 확인</b>하실수 있습니다. <br></br>
          <ul>
