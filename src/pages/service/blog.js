      ...
      <Grid cols="12" gap="10px">
        ...
        <Col xxl="8" md="6" sm="12">
          ...
          >
            ...
            <p>
              일반형은 업종별로 <span className = "HL">지역독점권</span>을 드리므로, 늦게 신청하시면 서비스
              진행이 불가할 수 있습니다. 실속형은 지역독점권이 없고, 해당
              카테고리 한정 독점권을 갖게 됩니다. 실속형은 한 권역별 최대
              2팀까지 가능합니다. 이외 별도 맞춤형 상품이 필요하시다면 문의하기
              메뉴를 활용해주세요.
            </p>
